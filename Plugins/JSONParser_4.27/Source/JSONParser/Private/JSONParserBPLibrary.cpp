...
void UJSONParserBPLibrary::BeginDestroy(){
...
FVector UJSONParserBPLibrary::JsonObjectToVector(FSJsonObject jsonObject){
	FVector vector;
	if (jsonObject.ue4Object != nullptr) {
		vector.X = jsonObject.ue4Object->GetNumberField(TEXT("X"));
		vector.Y = jsonObject.ue4Object->GetNumberField(TEXT("Y"));
		vector.Z = jsonObject.ue4Object->GetNumberField(TEXT("Z"));
	}
	return vector;
}
...
FRotator UJSONParserBPLibrary::JsonObjectToRotator(FSJsonObject jsonObject){
	FRotator rotator;
	if (jsonObject.ue4Object != nullptr) {
		rotator.Pitch = jsonObject.ue4Object->GetNumberField(TEXT("Pitch"));
		rotator.Yaw = jsonObject.ue4Object->GetNumberField(TEXT("Yaw"));
		rotator.Roll = jsonObject.ue4Object->GetNumberField(TEXT("Roll"));
	}
	return rotator;
}
...
FTransform UJSONParserBPLibrary::JsonObjectToTransform(FSJsonObject jsonObject){
	...
	if (jsonObject.ue4Object != nullptr) {
		...
		if (jsonObject.ue4Object->GetObjectField(TEXT("Translation")) != nullptr) {
			TSharedPtr<FJsonObject>	jsonVector = jsonObject.ue4Object->GetObjectField(TEXT("Translation"));
			FVector vector;
			vector.X = jsonVector->GetNumberField(TEXT("X"));
			vector.Y = jsonVector->GetNumberField(TEXT("Y"));
			vector.Z = jsonVector->GetNumberField(TEXT("Z"));
			transform.SetLocation(vector);
		}
		if (jsonObject.ue4Object->GetObjectField(TEXT("Scale3D")) != nullptr) {
			TSharedPtr<FJsonObject>	jsonVector = jsonObject.ue4Object->GetObjectField(TEXT("Scale3D"));
			FVector vector;
			vector.X = jsonVector->GetNumberField(TEXT("X"));
			vector.Y = jsonVector->GetNumberField(TEXT("Y"));
			vector.Z = jsonVector->GetNumberField(TEXT("Z"));
		...
		if (jsonObject.ue4Object->GetObjectField(TEXT("Rotation")) != nullptr) {
			TSharedPtr<FJsonObject>	jsonRotator = jsonObject.ue4Object->GetObjectField(TEXT("Rotation"));
			FQuat rotation;
			rotation.X = jsonRotator->GetNumberField(TEXT("X"));
			rotation.Y = jsonRotator->GetNumberField(TEXT("Y"));
			rotation.Z = jsonRotator->GetNumberField(TEXT("Z"));
			rotation.W = jsonRotator->GetNumberField(TEXT("W"));
...
void UJSONParserBPLibrary::addJobToThread(FSJsonThreadJobData* jobData){
	if (jobData == nullptr) {
		return;
	}
	if (jsonThread == nullptr) {
