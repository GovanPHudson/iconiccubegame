...
void ENUpdatePopup::Open()
{
	...
	TSharedRef<SVerticalBox> InnerContent = SNew(SVerticalBox)
		...
		[
			SNew(STextBlock)
			.Font(HeadingFont)
			.Text(FText::FromString("Electronic Nodes v3.6"))
		]
		+ SVerticalBox::Slot()
		  .FillHeight(1.0)
		  .Padding(10)
...
* Fix master activation with hot reload (<a id="browser" href="https://github.com/hugoattal/ElectronicNodes/issues/52">issue #52</>)
